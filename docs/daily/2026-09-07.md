...
<span class="md-date">2026年09月07日 Monday</span>
...
**[AutoAgent](https://github.com/HKUDS/AutoAgent)** ★ 9766 | `Python`

AutoAgent: Fully-Automated and Zero-Code LLM Agent Framework

**[comfyui_LLM_party](https://github.com/heshengtao/comfyui_LLM_party)** ★ 2349 | `Python`

LLM Agent Framework in ComfyUI includes MCP sever, Omost,GPT-sovits, ChatTTS,GOT-OCR2.0, and FLUX prompt nodes,access to Feishu,discord,and adapts to all llms with similar openai / aisuite interfaces, such as o1,ollama, gemini, grok, qwen, GLM, deepseek, kimi,doubao. Adapted to local llms, vlm, gguf such as llama-3.3 Janus-Pro, Linkage graphRAG

**[awesome-llm-agents](https://github.com/kaushikb11/awesome-llm-agents)** ★ 1577 | `Python`
...
**[mcp](https://github.com/microsoft/mcp)** ★ 3646 | `C#`

Catalog of official Microsoft MCP (Model Context Protocol) server implementations for AI-powered data access and tool integration

**[freecad-mcp](https://github.com/neka-nat/freecad-mcp)** ★ 2052 | `Python`

FreeCAD MCP(Model Context Protocol) server

**[x64dbg-mcp-server](https://github.com/duty1g/x64dbg-mcp-server)** ★ 1901 | `Zig`
...
**[todo-for-ai](https://github.com/todo-for-ai/todo-for-ai)** ★ 1179 | `Python`
...
**[QuickDesk](https://github.com/barry-ran/QuickDesk)** ★ 437 | `QML`
...
=== "数据来源"
GitHub Trending · AI 分析：MiniMax MiniMax-M2.7 · 最后更新：2026年09月07日 Monday
