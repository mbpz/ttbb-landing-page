...
<span class="md-date">2026年09月26日 Saturday</span>
...
**[AutoAgent](https://github.com/HKUDS/AutoAgent)** ★ 9803 | `Python`

AutoAgent: Fully-Automated and Zero-Code LLM Agent Framework

**[comfyui_LLM_party](https://github.com/heshengtao/comfyui_LLM_party)** ★ 2368 | `Python`
...
**[dvergr](https://github.com/replikativ/dvergr)** ★ 37 | `Clojure`
...
**[feynman-tutor](https://github.com/koukekoukej-glitch/feynman-tutor)** ★ 24 | `Python`
...
**[tyk](https://github.com/TykTechnologies/tyk)** ★ 10833 | `Go`

Open Source API and AI Gateway supporting REST, GraphQL, TCP, gRPC and MCP (Model Context Protocol)

**[mcp](https://github.com/microsoft/mcp)** ★ 3714 | `C#`

Catalog of official Microsoft MCP (Model Context Protocol) server implementations for AI-powered data access and tool integration

**[freecad-mcp](https://github.com/neka-nat/freecad-mcp)** ★ 2476 | `Python`

FreeCAD MCP(Model Context Protocol) server

**[x64dbg-mcp-server](https://github.com/duty1g/x64dbg-mcp-server)** ★ 2077 | `Zig`
...
**[QuickDesk](https://github.com/barry-ran/QuickDesk)** ★ 490 | `QML`
...
**[mcp](https://github.com/oracle/mcp)** ★ 446 | `Python`
...
=== "数据来源"
GitHub Trending · AI 分析：MiniMax MiniMax-M2.7 · 最后更新：2026年09月26日 Saturday
