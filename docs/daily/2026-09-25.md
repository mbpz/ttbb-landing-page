...
<span class="md-date">2026年09月25日 Friday</span>
...
**[AutoAgent](https://github.com/HKUDS/AutoAgent)** ★ 9801 | `Python`
...
**[dvergr](https://github.com/replikativ/dvergr)** ★ 36 | `Clojure`
...
**[tyk](https://github.com/TykTechnologies/tyk)** ★ 10832 | `Go`

Open Source API and AI Gateway supporting REST, GraphQL, TCP, gRPC and MCP (Model Context Protocol)

**[mcp](https://github.com/microsoft/mcp)** ★ 3708 | `C#`

Catalog of official Microsoft MCP (Model Context Protocol) server implementations for AI-powered data access and tool integration

**[freecad-mcp](https://github.com/neka-nat/freecad-mcp)** ★ 2463 | `Python`

FreeCAD MCP(Model Context Protocol) server

**[x64dbg-mcp-server](https://github.com/duty1g/x64dbg-mcp-server)** ★ 2048 | `Zig`
...
**[QuickDesk](https://github.com/barry-ran/QuickDesk)** ★ 486 | `QML`
...
=== "数据来源"
GitHub Trending · AI 分析：MiniMax MiniMax-M2.7 · 最后更新：2026年09月25日 Friday
