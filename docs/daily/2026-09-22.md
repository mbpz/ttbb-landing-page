...
<span class="md-date">2026年09月22日 Tuesday</span>
...
**[AutoAgent](https://github.com/HKUDS/AutoAgent)** ★ 9796 | `Python`
...
**[tyk](https://github.com/TykTechnologies/tyk)** ★ 10827 | `Go`

Open Source API and AI Gateway supporting REST, GraphQL, TCP, gRPC and MCP (Model Context Protocol)

**[mcp](https://github.com/microsoft/mcp)** ★ 3693 | `C#`

Catalog of official Microsoft MCP (Model Context Protocol) server implementations for AI-powered data access and tool integration

**[freecad-mcp](https://github.com/neka-nat/freecad-mcp)** ★ 2437 | `Python`

FreeCAD MCP(Model Context Protocol) server

**[x64dbg-mcp-server](https://github.com/duty1g/x64dbg-mcp-server)** ★ 2030 | `Zig`
...
**[todo-for-ai](https://github.com/todo-for-ai/todo-for-ai)** ★ 1184 | `Python`
...
**[QuickDesk](https://github.com/barry-ran/QuickDesk)** ★ 474 | `QML`
...
=== "数据来源"
GitHub Trending · AI 分析：MiniMax MiniMax-M2.7 · 最后更新：2026年09月22日 Tuesday
